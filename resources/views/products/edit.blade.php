                                            ...
                                            <form action="{{route('product.update', $product->id)}}" method="POST"
                                                ...
                                                <div class="ml-3 mt-3 mb-3 ">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="top seller"
                                                            id="type" name="type">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="featured"
                                                            id="type" name="type">
                                                        <label class="form-check-label" for="type">
                                                            Featured
                                                        </label>
                                                ...
                                                <div>
                                                    <button type="submit"
                                                        class="btn btn-success btn-facebook btn-user btn-block ">Update
                                                        Product</button>
                                                </div>
                                            </form>
